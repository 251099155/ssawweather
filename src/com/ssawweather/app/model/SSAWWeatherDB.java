package com.ssawweather.app.model;

import java.util.ArrayList;
import java.util.List;

import com.ssawweather.app.db.SSAWWeatherOpenHelper;
...
public class SSAWWeatherDB {

	/*数据库名*/
	
	public static final String DB_NAME="ssaw_weather";
	
	/*数据库版本*/
	
	public static final int VERSION=1;
	
	private static SSAWWeatherDB ssawWeatherDB;
	...
	private SSAWWeatherDB(Context context){
		SSAWWeatherOpenHelper dbHelper=new SSAWWeatherOpenHelper(context, 
	...
	public synchronized static SSAWWeatherDB getInstance(Context context){
		
		if (ssawWeatherDB==null) {
			ssawWeatherDB=new SSAWWeatherDB(context);
		}
		
		return ssawWeatherDB;
	}
